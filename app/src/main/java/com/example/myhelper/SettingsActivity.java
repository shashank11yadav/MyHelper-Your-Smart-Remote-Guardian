...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class SettingsFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, final String rootKey) {
            ...
            Objects.requireNonNull(myPref).setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(@NonNull Preference preference) {
                    ...
                    final EditText editText= dialogView.findViewById(R.id.edit_name);
                    ...
                    buttonChange.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (networkInfo != null && networkInfo.isConnected()) {
                                ...
                                mDatabase.child(Objects.requireNonNull(currentFirebaseUser).getUid()).setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
            ...
            Objects.requireNonNull(myPref1).setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(@NonNull Preference preference) {
                    final AlertDialog dialogBuilder=new AlertDialog.Builder(getContext()).create();
                    LayoutInflater inflater=getLayoutInflater();
                    View dialogView= inflater.inflate(R.layout.dialog_box_for_changeloginpassword,null);
                    final EditText editCurrentPassword= dialogView.findViewById(R.id.edit_current_password);
                    final EditText editNewPassword= dialogView.findViewById(R.id.edit_new_password);
                    final EditText editConfirmPassword= dialogView.findViewById(R.id.edit_confirm_new_password);
                    Button buttonChange= dialogView.findViewById(R.id.buttonChange);
                    Button buttonCancel= dialogView.findViewById(R.id.buttonCancel);
                    final ProgressBar progressBar= dialogView.findViewById(R.id.progressbar);
            ...
            Objects.requireNonNull(myPref2).setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(@NonNull Preference preference) {
                    final AlertDialog dialogBuilder=new AlertDialog.Builder(getContext()).create();
                    LayoutInflater inflater=getLayoutInflater();
                    View dialogView= inflater.inflate(R.layout.dialog_box_for_changelockpin,null);
                    final EditText editCurrentPin=dialogView.findViewById(R.id.edit_current_pin);
                    final EditText editNewPin=dialogView.findViewById(R.id.edit_new_pin);
                    final EditText editConfirmPin=dialogView.findViewById(R.id.edit_confirm_new_pin);
                    Button buttonChange=dialogView.findViewById(R.id.buttonChange);
                    Button buttonCancel=dialogView.findViewById(R.id.buttonCancel);
                    final ProgressBar progressBar=dialogView.findViewById(R.id.progressbar);
            ...
            final SwitchPreference pref_contact= findPreference("access_contact");
            final SwitchPreference pref_location= findPreference("access_location");
            final SwitchPreference pref_profile= findPreference("access_profile");
            final SwitchPreference pref_alarm= findPreference("access_alarm");
            final SwitchPreference pref_lock= findPreference("access_lock");

            String permission= Manifest.permission.SEND_SMS;
            int grant= ContextCompat.checkSelfPermission(getContext(),permission);
            if(grant != PackageManager.PERMISSION_GRANTED){
                Objects.requireNonNull(pref_contact).setChecked(false);
                Objects.requireNonNull(pref_location).setChecked(false);
                Objects.requireNonNull(pref_profile).setChecked(false);
                Objects.requireNonNull(pref_alarm).setChecked(false);
                Objects.requireNonNull(pref_lock).setChecked(false);
            }
            ...
            Objects.requireNonNull(pref_contact).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
            ...
            Objects.requireNonNull(pref_location).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(@NonNull Preference preference, Object o) {
            ...
            Objects.requireNonNull(pref_profile).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(@NonNull Preference preference, Object o) {
            ...
            Objects.requireNonNull(pref_alarm).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(@NonNull Preference preference, Object o) {
            ...
            Objects.requireNonNull(pref_lock).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(@NonNull Preference preference, Object o) {
